<x-guest-layout>
    ...
    <div class="flex items-center justify-center mt-4">
        <p class="text-sm text-blue-700 dark:text-blue-300">
            ...
            <a href="{{ route('register') }}" class="underline text-blue-700 dark:text-blue-300 hover:text-blue-900 dark:hover:text-blue-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800">
                {{ __('Register here') }}
            </a>
        </p>
    </div>
